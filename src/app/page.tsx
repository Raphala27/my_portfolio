...
export default function Home() {
  return (
    <>
      <HeroBackground />
      <main className="min-h-screen selection:bg-chic-accent selection:text-chic-brown relative z-10 overflow-hidden">
        <Navbar />
        ...
        {/* Contact Section */}
        <section id="contact" className="bg-chic-dark text-chic-bg py-24 relative z-10">
